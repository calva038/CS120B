...
typedef struct _task {
	/*Tasks should
	have members that include: state, period,
	...
	//Time elapsed since last task tick int
	int (*TickFct)(int);
	//Task tick function
}
...
int main(){
	...
	//Task current elapsed time.
	task1.TickFct = &SMTick1;
	//Function pointer for the tick.
	// Task 2
	task2.state = -1;
	//Task initial state.
